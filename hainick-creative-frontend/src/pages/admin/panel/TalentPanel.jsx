// TODO: Sambungkan ke API backend untuk fetch & update data Talent
      ...
      <div className="panel-wrap">
        <div className="panel-header">
          <div className="panel-header-left">
            ...
            <p className="panel-page-sub">Kelola data talent dan tim</p>
          </div>
          <button className="panel-add-btn">+ Tambah Talent</button>
        </div>
        ...
        <div className="panel-card">
          <div className="panel-card-header">
            <span className="panel-card-title">Daftar Talent</span>
            <input
          ...
          <div className="panel-table-wrap">
            ...
            */}
            <div className="empty-state">
              ...
              <p>Belum ada data Talent.</p>
              <p>
                Klik <strong>+ Tambah Talent</strong> untuk mulai.
              </p>
            </div>
          </div>
        </div>
