// TODO: Sambungkan ke API backend untuk fetch & update data Home
      ...
      <div className="panel-wrap">
        <div className="panel-header">
          <div className="panel-header-left">
            ...
            <p className="panel-page-sub">
              Kelola konten hero section landing page
            </p>
          </div>
          <button className="panel-add-btn">+ Tambah Home</button>
        </div>
        ...
        <div className="panel-card">
          <div className="panel-card-header">
            <span className="panel-card-title">Daftar Home</span>
            <input
          ...
          <div className="panel-table-wrap">
            ...
            */}
            <div className="empty-state">
              ...
              <p>Belum ada data Home.</p>
              <p>
                Klik <strong>+ Tambah Home</strong> untuk mulai.
              </p>
            </div>
          </div>
        </div>
