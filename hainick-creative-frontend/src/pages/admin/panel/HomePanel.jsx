      ...
      <div className="panel-wrap">
        <div className="panel-header">
          <div className="panel-header-left">
            ...
            <p className="panel-page-sub">Kelola hero banner landing page</p>
          </div>
          <button
          ...
          <div className="hero-preview-wrap">
            {loading ? (
              ...
              <>
                ...
                <div className="hero-meta">
                  <div className="hero-meta-info">
                    <span className="hero-meta-label">URL Gambar</span>
                    <span className="hero-meta-val">{heroUrl}</span>
                  </div>
                  <button
                    className="panel-add-btn"
              ...
              <div className="hero-empty">
                ...
                <span>
                  Klik <strong>+ Upload Banner</strong> untuk mengunggah.
                </span>
              </div>
            )}
          </div>
